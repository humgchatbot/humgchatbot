export default {
  ...
  CONNECTED_WARN: '\nChúc quý khách hợp tác vui vẻ <3 ',
  ...
  //Ghép nối
  //CONNECTED_AD: '[Hãng hàng không HUMG Chatbot]\n🆗Xin thông báo, quý khách đã yêu cầu kết nối lại thành công với ID ✅: ',
  ...
  ERR_200: '[HUMG Chatbot] Cá không thể nhận tin nhắn do đã xóa inbox hoặc block page.',
