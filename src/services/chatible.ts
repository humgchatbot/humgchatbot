...
const pairPeople = async (id1: string, id2: string, gender1: GenderEnum, gender2: GenderEnum): Promise<void> => {
  ...
  await fb.sendTextMessage('', id1, lang.CONNECTED+id2,lang.CONNECT_NOTE, false);
  //await fb.sendTextMessage('',id1,lang.CONNECT_ID+id2,lang.CONNECT_NOTE,false);
  await fb.sendTextMessage('', id2, lang.CONNECTED+id1,lang.CONNECT_NOTE, false);
  //await fb.sendTextMessage('',id2,lang.CONNECT_ID+id1,lang.CONNECT_NOTE,false);
